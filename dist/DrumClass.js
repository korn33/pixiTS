...
export class Drum {
    ...
    initializationDrum(arrAddress) {
        ...
        drumFrame.drawRect(this.arrAllSprites[0].x - prop.simbols.size / 2, prop.btnStart.height + 2 * prop.simbols.size, prop.simbols.size + init.retreatIcons * 2, prop.simbols.size * 3 + init.retreatIcons * 4 - 1);
        drumFrame.endFill();
        drumFrame.zIndex = 1;
...
//# sourceMappingURL=DrumClass.js.map